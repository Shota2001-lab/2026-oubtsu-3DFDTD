...
% 1：水, 2：PLLA, 3：真鍮
c11 = [K 15.34e9 bC11]; % PLLA弾性マトリクス、J. Phys. Chem. B 114, 9, 2010, T. Lin, X.Liu
c12 = [K 5.25e9 bC12];
c13 = [K 10.01e9 bC12];
c33 = [K 28.62e9 bC11];
c44 = [0 13e9 bC44];
...
if flag
    ...
    dtdx.C44 = single(c44(is_model_share + 1)) * para.solution.dt / para.solution.dx;
    dtdx.C66 = single(c66(is_model_share + 1)) * para.solution.dt / para.solution.dx;
    ...
    dtdz.C44 = single(c44(is_model_share + 1)) * para.solution.dt / para.solution.dz;
