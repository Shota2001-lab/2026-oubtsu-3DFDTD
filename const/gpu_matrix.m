...
Ex = gpuArray(single(zeros(nx+1, ny+1, nz+1)));
Ey = gpuArray(single(zeros(nx+1, ny+1, nz+1)));
Ez = gpuArray(single(zeros(nx+1, ny+1, nz+1)));

tEx = gpuArray(single(zeros(nx+1, ny+1, nz+1)));
tEy = gpuArray(single(zeros(nx+1, ny+1, nz+1)));
tEz = gpuArray(single(zeros(nx+1, ny+1, nz+1)));
